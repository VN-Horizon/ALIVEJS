...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Populate basic
  (document.getElementById("text-speed") as HTMLInputElement).value = String(currentSettings.textSpeed);
  (document.getElementById("screen-effects-speed") as HTMLInputElement).value = String(currentSettings.screenEffectsSpeed);
  (document.getElementById("screen-effects") as HTMLInputElement).checked = currentSettings.screenEffectsEnabled;
  ...
  (document.getElementById("font-aa") as HTMLInputElement).value = String(currentSettings.fontAntiAliasing);

  // Populate save/load
  (document.getElementById("save-confirm") as HTMLInputElement).checked = currentSettings.saveConfirm;
  (document.getElementById("save-dblclick") as HTMLInputElement).checked = currentSettings.saveDblclick;
  (document.getElementById("save-auto-select") as HTMLInputElement).checked = currentSettings.saveAutoSelect;
  (document.getElementById("save-skip-auto") as HTMLInputElement).checked = currentSettings.saveSkipAuto;
  
  (document.getElementById("load-dblclick") as HTMLInputElement).checked = currentSettings.loadDblclick;
  (document.getElementById("load-auto-select") as HTMLInputElement).checked = currentSettings.loadAutoSelect;
  (document.getElementById("load-skip-auto") as HTMLInputElement).checked = currentSettings.loadSkipAuto;
  
  (document.getElementById("auto-save") as HTMLInputElement).checked = currentSettings.autoSaveEnabled;
  (document.getElementById("auto-save-slot") as HTMLInputElement).value = String(currentSettings.autoSaveSlot);
  (document.getElementById("auto-save-comment") as HTMLInputElement).value = currentSettings.autoSaveComment;

  // Populate sound
  (document.getElementById("bgm-vol") as HTMLInputElement).value = String(currentSettings.bgmVolume);
  ...
  (document.getElementById("voice-vol") as HTMLInputElement).value = String(currentSettings.voiceVolume);
  (document.getElementById("voice-sys") as HTMLInputElement).checked = currentSettings.voiceUseSystem;
  ...
  const getUpdatedSettings = () => {
    ...
    s.screenEffectsSpeed = parseInt((document.getElementById("screen-effects-speed") as HTMLInputElement).value, 10);
    s.screenEffectsEnabled = (document.getElementById("screen-effects") as HTMLInputElement).checked;
    ...
    s.fontAntiAliasing = parseInt((document.getElementById("font-aa") as HTMLInputElement).value, 10);
    ...
    s.autoSaveSlot = parseInt((document.getElementById("auto-save-slot") as HTMLInputElement).value, 10);
